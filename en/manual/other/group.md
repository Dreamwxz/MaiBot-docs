...
Welcome to the MaiMai community! Here are various ways to connect with us.
...
<div class="section-header">
  ...
  <h2 class="section-title">QQ Groups</h2>
</div>
...
<div class="qq-card">
  <div class="card-top">
    ...
    <span class="type-tag tech">Technical Discussion</span>
  </div>
  <h3 class="group-name">MaiMai EEG</h3>
...
<div class="qq-card">
  ...
  <h3 class="group-name">MaiMai Brain MRI</h3>
...
<div class="qq-card">
  ...
  <h3 class="group-name">MaiMai Wants to be a VTB</h3>
...
<div class="qq-card">
  <div class="card-top">
    <span class="group-icon">🌊</span>
    <span class="type-tag chat">Casual Chat</span>
  </div>
  <h3 class="group-name">MaiMai Casual Chat Group</h3>
...
<div class="qq-card">
  <div class="card-top">
    <span class="group-icon">🧩</span>
    <span class="type-tag dev">Plugin Development</span>
  </div>
  <h3 class="group-name">Plugin Development Group</h3>
...
<a href="https://discord.gg/UvgPVSVX" target="_blank" rel="noopener" class="social-card">
  ...
  <div class="social-info">
    ...
    <div class="social-handle">Join Server</div>
  </div>
</a>
...
<div class="community-tip">
  <p><span class="tip-icon">💡</span> Technical discussion groups are for technical questions and support only. For casual chat, please join the casual chat group.</p>
</div>
